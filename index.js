...
import { deleteLike } from "./delete-card.js";
import { PopupWithImage } from "./popup-images.js";
...
export function createCat(dataCats) {
  const newElement = new Card(dataCats, "#card-template", handleClickCatImage);
...
export function updateLocalStorage(data, action) {
